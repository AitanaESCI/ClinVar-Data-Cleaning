...
def process_vep_output(df):
    ...
    extra_fields = ['SYMBOL', 'HGNC_ID', 'CANONICAL', 'SWISSPROT', 'UNIPARC', 'UNIPROT_ISOFORM', 
                    'SIFT', 'PolyPhen', 'am_class', 'am_pathogenicity', 'BayesDel',
                    'CADD_PHRED', 'CADD_RAW', 'ClinPred', 'VEST4_rankscore', 
    ...
    selected_columns = [
        ...
        'PolyPhen_label', 'PolyPhen_score', 'BayesDel_label', 'CADD_PHRED_score', 
        'CADD_RAW_score', 'ClinPred_score', 'VEST4_score', 'VEST4_rankscore', 'EVE_label', 
        'EVE_score', 'REVEL_score', 'PrimateAI_score', 'AM_label', 'AM_score'
    ]
